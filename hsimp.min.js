        ...
        18: [function(e, a, r) {
            ...
            var o = e("hsimp-main/bootstrap")(e("hsimp-main")),
                ...
                i = n.curry(function(e, a) {
                    ...
                    var i = n.isFunction(e.outputTime) ? e.outputTime : n.noOp,
                        s = n.isFunction(e.outputChecks) ? e.outputChecks : n.noOp;
                        // t = n.isObject(e.options) ? e.options : {};
                        // r = a.getAttribute("class") + " contenedor-1";
                        // a.setAttribute("class", r);
                        // o.setOptions(t), 
                        a.addEventListener("keyup", function(e) {
                            // if (13 == e.keyCode) {
                            var e = o(a.value),
                                nivelsecu = e.getSecurityLevel();
                                a.value.length ? (i(e.getString(), a), 
                                s(e.getChecks(), a)) : (i(!1, a), s([]));

                                console.log(nivelsecu);
                            // }
                        })
                });
